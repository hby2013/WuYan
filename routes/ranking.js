                        ...
                        for(var j = 0; j < docs.length; j++) {
                            for(var i = 0; i < near_user.length; i++) {
                                if(docs[j].openid == near_user[i].openid) {
                                    near_user[i].day_step = 1;
                                    near_user[i].day_sport_time = 1;
                                    near_user[i].day_clr = 1;
                                    if(docs[j].date.getTime() == new Date(today).getTime()) {
                                        near_user[i].day_step = parseInt(docs[j].steps);
                                        near_user[i].day_sport_time = parseInt(docs[j].sport_time);
                                        near_user[i].day_clr = parseInt(docs[j].calories);
                                    }
                                    near_user[i].week_clr += parseInt(docs[j].calories);
                                    near_user[i].week_sport_time += parseInt(docs[j].sport_time);
                                    near_user[i].week_step += parseInt(docs[j].steps);
                                    break;
                                }
                            }
                        }
