...
function show_flags(){
    ...
    for(var i=1; i<=total_flags; i++) {
        //alert(countries1[0]);
        single_flag = $("<img class='flag_visited' id='flag"+i+"'src='img/flags/"+convert_picname(countries1[i-1])+" Flag.png'>");
...
function show_detail() {
    $("#mask_page2").fadeIn(function(){
        var detail_img = $("<img class='detail_img' src='img/world_images/"+convert_picname(countries1[flag_click])+".jpg'>");
        if(infos.length>0) {
